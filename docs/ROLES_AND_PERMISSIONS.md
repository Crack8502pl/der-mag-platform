...
Grover Platform wykorzystuje **Role-Based Access Control (RBAC)** z granularnymi uprawnieniami przechowywanymi w formacie JSON. System został rozszerzony do 10 ról, aby dokładnie odpowiadać wymaganiom biznesowym różnych zespołów i procesów w organizacji.
...
└───────────────────────┬─────────────────────────────────────┘
        ...
        ▼               ▼                ▼             ▼
┌──────────────┐  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐
│ MANAGEMENT   │  │   MANAGER    │  │  BOM EDITOR  │  │ COORDINATOR  │
│    BOARD     │  │              │  │              │  │              │
│              │  │              │  │              │  │              │
│ Zarządzanie  │  │ Wszystkie    │  │ Zarządzanie  │  │ Tylko zadania│
│ menadżerami  │  │ typy zadań   │  │ materiałami  │  │   SERWIS     │
│ Projektami   │  │ Użytkownicy  │  │ Integracja   │  │ Przypisania  │
│ Raportami    │  │ Zatwierdzanie│  │ Symfonia     │  │ Aktualizacje │
└──────────────┘  └──────────────┘  └──────────────┘  └──────────────┘
        │               │                │                │
        └───────────────┼────────────────┼────────────────┘
                        │                │
        ...
        ▼               ▼                ▼                ▼
┌──────────────┐  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐
│PREFABRICATOR │  │   WORKER     │  │ORDER_PICKING │  │  INTEGRATOR  │
│              │  │              │  │              │  │              │
│ Rejestracja  │  │ Realizacja   │  │ Kompletacja  │  │ API System   │
│ urządzeń     │  │ zadań        │  │ podzespołów  │  │ Integracje   │
│ Weryfikacja  │  │ Checklisty   │  │ Seryjne      │  │ zewnętrzne   │
│ SN           │  │ Upload zdjęć │  │ Palety       │  │ Import danych│
└──────────────┘  └──────────────┘  └──────────────┘  └──────────────┘
                        │
                        ▼
                ┌──────────────┐
