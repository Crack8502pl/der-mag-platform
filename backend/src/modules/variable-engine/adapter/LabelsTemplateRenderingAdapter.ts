/**
 * Variable Engine – LabelsTemplateRenderingAdapter (L-12)
 *
 * Connects the Variable Engine to Labels (product label / barcode) template
 * rendering paths.
 *
...
export type LabelsRenderContext = VariableContext;

export class LabelsTemplateRenderingAdapter {
