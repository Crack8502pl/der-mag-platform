...
interface ShipmentWizardSmokBProps {
  subsystem: Subsystem;
  onClose: () => void;
  onSuccess: () => void;
}
  ...
  const renderStep1 = () => (
    <>
      ...
      <div className="form-group">
        <label htmlFor="smb-deliveryAddress">Adres dostawy *</label>
        <textarea
          id="smb-deliveryAddress"
      ...
      <div className="form-group">
        <label htmlFor="smb-contactPhone">Telefon kontaktowy *</label>
        <input
          id="smb-contactPhone"
          type="tel"
    ...
    <>
      <div className="modal-overlay" onClick={onClose}>
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="smb-wizard-title"
