...
export const Dashboard: React.FC = () => {
  ...
  const moduleCards: ModuleCard[] = [
    ...
    { title: 'Mapa Zadań', path: '/map', icon: <ModuleIcon name="map" emoji={MODULE_ICONS.map} size={48} />, module: 'tasks', action: 'read', description: 'Lokalizacje zadań na mapie', group: 'planning' },
