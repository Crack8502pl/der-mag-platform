...
export const Dashboard: React.FC = () => {
  ...
  const moduleCards: ModuleCard[] = [
    ...
    { title: 'Realizacja', path: '/realization', icon: <ModuleIcon name="realization" emoji={MODULE_ICONS.realization} size={48} />, module: 'realization', action: 'read', description: 'Zarządzanie realizacją zleceń', group: 'execution' },
